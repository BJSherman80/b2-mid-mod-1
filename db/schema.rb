...
ActiveRecord::Schema.define(version: 2020_10_23_154129) do
  ...
  create_table "parks", force: :cascade do |t|
    t.string "name"
    t.integer "admission_price", default: 0
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
  ...
  create_table "repairs", force: :cascade do |t|
    ...
    t.index ["ride_id"], name: "index_repairs_on_ride_id"
  end
